    ...
    <div className="left-pane">
      <div className="container">
        ...
        <nav>
          ...
          <Link to="/explore" activeClassName="selected">
            <span>
              <svg
                fill="currentColor"
                viewBox="0 0 24 24"
          ...
          <Link to="/notifications" activeClassName="selected">
            <span>
              <svg
                fill="currentColor"
                viewBox="0 0 24 24"
          ...
          <Link to="/bookmarks" activeClassName="selected">
            <span>
              {" "}
              <svg
                fill="currentColor"
          ...
          <Link to="/lists" activeClassName="selected">
            <span>
              <svg
                fill="currentColor"
                viewBox="0 0 24 24"
        ...
        <footer>
          <button className="account">
            ...
            <div>
              <div className="name">Mohammed Farhan</div>
              <div className="username">@mohammedfarhan</div>
            </div>
          </button>
        </footer>
      </div>
